<%--
    Document   : map
    Created on : 2011-01-19, 04:00:37
    Author     : Bartek
 *
	...
	<script type='text/javascript'>
		...
		function initialize()
		{
			 var wspolrzedne = new google.maps.LatLng(50.288896,18.67430);
				...
				downloadUrl('/CarSpyServer6/MakeXML.do?uid=<%= request.getParameter("uid") %>', function(dane)
				{
